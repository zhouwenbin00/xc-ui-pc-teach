  ...
  <div>
    ...
    <div id="wrapper">
      <div class="uploader-container">
        ...
        <el-button style="margin-bottom:5px;float:left;" size="small" :loading="uploadLoading" type="success"
                   @click="start">上传到服务器
        </el-button>
        <el-button style="margin-left: 20px;margin-bottom:10px;float:left;" :disabled="stopBtn" size="small"
                   type="danger" @click="stop">暂停上传
        </el-button>
      </div>
    </div>
